...
/** Natural ease — feels like content settling in, not popping */
const easeOut = [0.22, 1, 0.36, 1] as const;

/** Gym / weights — bundled in `public/images` (Unsplash, free to use) */
const GYM_HERO_BG = "/images/gym-hero-bg.jpg";
...
export default function ClientWelcomePage() {
    ...
    const fetchProfile = async () => {
      try {
        ...
        if (response.status === 'success') {
          ...
          setUser(storedUser || { name: 'Client', role: 'client', email: 'client@example.com' });
        }
      } catch (error) {
  ...
  const displayUser = user || { name: 'Client', role: 'client', email: 'client@example.com' };
    ...
    <div className="relative min-h-screen w-full overflow-x-clip bg-dark-900">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div
          ...
          style={{ backgroundImage: `url(${GYM_HERO_BG})` }}
          aria-hidden
        />
          ...
          <div className="mx-auto flex w-full max-w-[1400px] items-center justify-between px-4 py-4 sm:px-6">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Fitness Hub</p>
              </div>
            </motion.div>
          ...
          <section className="relative w-full px-4 py-20 sm:px-6">
            <div className="relative z-10 mx-auto w-full max-w-4xl">
              ...
              >
                ...
                >
                  Start your transformation today with personalized coaching and
                  comprehensive workout plans designed just for you.
                </motion.p>
