...
import { ArrowLeft, Unlock, ShieldCheck } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-dark-950 via-dark-900 to-dark-950 overflow-hidden">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute top-1/4 left-1/4 w-96 h-96 bg-green-600/10 rounded-full blur-3xl"
        />
        <motion.div
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-10">
              <motion.div
                ...
                className="w-16 h-16 bg-gradient-to-br from-green-600/30 to-green-500/20 rounded-2xl flex items-center justify-center border border-green-500/30 shadow-lg shadow-green-600/20"
              >
                <ShieldCheck className="w-8 h-8 text-green-400" />
              </motion.div>
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-white">Reactivate Account</h1>
                <p className="text-gray-400 mt-1">Restore a deactivated account</p>
              </div>
            </div>
            ...
            <AnimatePresence mode="wait">
              {success ? (
                ...
                >
                  ...
                  <h2 className="text-xl font-semibold text-white mb-2">Account reactivated</h2>
                ...
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -10 }}
                  className="rounded-2xl bg-gradient-to-br from-dark-800/80 to-dark-900/60 border border-dark-700/80 p-8 shadow-lg hover:shadow-xl hover:border-green-500/20 transition-all"
                >
