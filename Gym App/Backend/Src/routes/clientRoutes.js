...
// 4c - Get subscription plans (no auth required)
router.get('/plans', clientController.getSubscriptionPlans);
...
// 11c - Get all coaches (for booking)
router.get('/dashboard/coaches', verifyBearerToken, checkRole('client'), clientController.getAllCoaches);
