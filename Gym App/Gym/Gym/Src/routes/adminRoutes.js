...
// 4b - Get all coaches and clients
router.get('/dashboard/all-coaches', verifyBearerToken, checkRole('admin'), adminController.getAllCoaches);
router.get('/dashboard/all-clients', verifyBearerToken, checkRole('admin'), adminController.getAllClients);

// 5 - Add coach (Register coach)
...
// 19 - Get all subscription plans
router.get('/dashboard/plans', verifyBearerToken, checkRole('admin'), adminController.getSubscriptionPlans);

// 20 - Create subscription plan
router.post('/dashboard/plans', verifyBearerToken, checkRole('admin'), adminController.createSubscriptionPlan);

// 21 - Update subscription plan
router.put('/dashboard/plans/:planId', verifyBearerToken, checkRole('admin'), adminController.updateSubscriptionPlan);

// 22 - Delete subscription plan
router.delete('/dashboard/plans/:planId', verifyBearerToken, checkRole('admin'), adminController.deleteSubscriptionPlan);
